...
input_fasta_file = r"../data/C.jejuni/protein.test.all"
output_npy_file = r'../data/C.jejuni/numpy.test.esm.feature11.npy'
output_reduced_npy_file = r'../data/C.jejuni/jiangwei.numpy.test.esm.feature.npy'
